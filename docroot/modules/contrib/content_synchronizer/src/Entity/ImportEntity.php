 ...
 *   handlers = {
 *     "view_builder" =
 *   "Drupal\content_synchronizer\Entity\ImportEntityViewBuilder",
 *     "list_builder" = "Drupal\content_synchronizer\ImportEntityListBuilder",
 *     "views_data" =
 *   "Drupal\content_synchronizer\Entity\ImportEntityViewsData",
 *
 *     "form" = {
 ...
 *     },
 *     "access" =
 *   "Drupal\content_synchronizer\ImportEntityAccessControlHandler",
 *     "route_provider" = {
