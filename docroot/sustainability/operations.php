...
<head>
  ...
  <title>Our Operations | Casella Resource Solutions</title>
  ...
  <div class="mapImageContainer">
    <div class="mapContentContainer">
      <div class="globalWidth">
        ...
        <div id="mapTitle" class="mapTitle">Our Operations</div>
        <div id="mapKey" class="mapKey">
          <form>
    ...
    <div id="layerCollection" class="mapLayers"><img src="img/map/Map-Collection.png" alt=""></div>
    <div id="layerRecycling" class="mapLayers"><img src="img/map/Map-Recycle.png" alt=""></div>
    <div id="layerOrganics" class="mapLayers"><img src="img/map/Map-Organic.png" alt=""></div>
    <div id="layerLandfills" class="mapLayers"><img src="img/map/Map-Landfill.png" alt=""></div>
    <div id="layerLandfillsGas" class="mapLayers"><img src="img/map/Map-LandfillGas.png" alt=""></div>
    <div id="layerTransfer" class="mapLayers"><img src="img/map/Map-Transfer.png" alt=""></div>
    <img src="img/map/Map-Background-Sustainability.jpg" alt="">
  </div>
  
  
  <!--//////////////////////////////////////////////-->
  
  <div class="keyMobileContainer globalWidth">
