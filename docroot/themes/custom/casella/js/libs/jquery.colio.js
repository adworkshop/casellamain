	...
	*/
	...
	$.fn.colio = function(c) {
		...
		var s = $.extend({
			...
			expandEasing: 'linear',				// easing for expand animation
			collapseDuration: 300,				// duration of collapse animation, ms
			collapseEasing: 'linear',			// easing for collapse animation
			...
			scrollEasing: 'linear',				// page scroll easing
			scrollOffset: 100,					// viewport offset from top of the page, px
