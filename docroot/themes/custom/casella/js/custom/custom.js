jQuery(document).ready(function() {
  ...
  jQuery('#edit-field-application-0-upload').append('<div class="file-download"><span><a href="https://www.casella.com/sites/default/files/pdfs/HR-Application-English-v11-FILL.pdf" target="_blank" title="Download the Application">Download the application (PDF)</a>,<br>once completed and saved, click "Choose File" to submit.</span></div></div>');
