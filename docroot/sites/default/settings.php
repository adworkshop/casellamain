 ...
 * @endcode
 */
$settings['hash_salt'] = 'jklasd789r3qkjsfedhjr370sui3rhc6';
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_devcloud_casellarefresh_dev_default.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_devcloud_casellarefresh_dev_default.inc';
}
// </DDSETTINGS>
